...
//   //     httpMetric.putAttribute('userId', global.userid);
//   //     httpMetric.putAttribute('endpoint', GetUrlEndpoint(config.url));
//   //     await httpMetric.start();
//   //   } catch (e) {
//   //     consoleLog('axios.interceptors.request.use', e);
//   //   } finally {
//   //     return config;
//   //   }
//   // });
...
//   //     } catch (e) {
//   //       consoleLog('axios.interceptors.response.use ', e);
//   //     } finally {
//   //       return response;
//   //     }
//   //   },
...
//   //       await httpMetric.stop();
//   //     } catch (e) {
//   //       consoleLog('async function (error) ', e);
//   //     } finally {
//   //       return Promise.reject(error);
//   //     }
//   //   }
//   // );
//   // consoleLog('headerList-' + endpoint, headerList);
...
//     consol\eLog('apiresponse', JSON.stringify(res.data));
...
//   headerObj['X-IMI-DEV-ID'] = deviceUniqueId;
//   headerObj['X-IMI-HDSIGN'] = hdSignHash;
//   headerObj['X-IMI-LANGUAGE'] = languageSelected;
...
//   headerObj['X-IMI-UID'] = timestamp + '';
//   headerObj['X-IMI-UNIQUEID'] = deviceUniqueId;
...
//   headerObj['X-IMI-TOKENID'] = tokenid?.toString() ?? '';
//   headerObj['X-IMI-UID'] = timestamp; ///'1617866819752523';
//   headerObj['X-IMI-UNIQUEID'] = deviceUniqueId;
//   headerObj['X-IMI-VERSION'] = appVersion;
//   headerObj['X-IMI-RNST'] = new Date().getTime() + '';
//   headerObj['X-IMI-APPTYPE'] = '1';
